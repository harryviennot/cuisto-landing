...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: "Instagram",
      href: "https://instagram.com/cuisto.app",
      icon: (
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12">
            ...
            >
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-forest-600 flex items-center justify-center shadow-lg ">
                  <img
