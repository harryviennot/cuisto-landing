...
const steps = [
  {
    ...
    description:
      "Paste a TikTok link, drop a screenshot, or snap a photo of grandma's handwritten recipe. We accept it all.",
    features: ["TikTok & Instagram", "Photos & Screenshots", "URLs & Links", "Voice notes"],
  ...
  },
  {
    ...
    subtitle: "AI magic",
    description:
      "Our AI watches videos, reads images, and transcribes audio. In seconds, chaos becomes a structured recipe.",
    features: ["Video transcription", "Image OCR", "Smart parsing", "Auto-formatting"],
    gradient: "from-primary to-forest-800",
  },
  {
    number: "03",
    title: "Cook",
    ...
    description:
      "Beautiful recipe cards with step-by-step instructions, built-in timers, and ingredient scaling. Finally, cooking without chaos.",
    features: ["Step-by-step mode", "Built-in timers", "Ingredient scaling", "Personal notes"],
    gradient: "from-forest-600 to-forest-900",
  },
];
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          >
            Three steps to{" "}
            <span className="text-forest-300 italic">recipe freedom</span>
          </h2>
          <p className="mt-6 text-xl text-forest-300 max-w-2xl mx-auto">
            From scattered links to organized cookbook in under 30 seconds.
          </p>
        </motion.div>
          ...
          <div className="space-y-24 lg:space-y-32">
            {steps.map((step, index) => (
              ...
              >
                {/* Timeline dot */}
                <div
                  className={`absolute left-8 lg:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-gradient-to-br ${step.gradient} ring-4 ring-forest-950`}
                />
                ...
                >
                  ...
                  >
                    <span
                      className={`text-sm font-bold px-3 py-1 rounded-full bg-gradient-to-r ${step.gradient} text-white`}
                    >
                      {step.number}
                    </span>
                ...
                >
                  <div className="relative">
                    ...
                    <div className="relative mx-auto w-64 sm:w-72">
                      ...
                      {/* Glow effect */}
                      <div
                        className={`absolute inset-0 rounded-[2.5rem] bg-gradient-to-br ${step.gradient} opacity-20 blur-2xl -z-10`}
                      />
                    </div>
                  </div>
                </div>
